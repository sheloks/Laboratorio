import {
  ...
  watch,
  watchEffect
} from "./chunk-BE5IGOWN.js";
import "./chunk-7YOUGTII.js";
...
function refWithControl(initial, options = {}) {
  ...
  function set$1(value, triggering = true) {
    ...
    if (value === source)
      return;
    const old = source;
    if (((_options$onBeforeChan = options.onBeforeChange) === null || _options$onBeforeChan === void 0 ? void 0 : _options$onBeforeChan.call(options, value, old)) === false)
      return;
    source = value;
...
function syncRef(left, right, ...[options]) {
  ...
  if (direction === "both" || direction === "ltr")
    watchers.push(pausableWatch(left, (newValue) => {
  ...
  if (direction === "both" || direction === "rtl")
    watchers.push(pausableWatch(right, (newValue) => {
      watchers.forEach((w) => w.pause());
...
function createUntil(r, isNot = false) {
  function toMatch(condition, { flush = "sync", deep = false, timeout, throwOnTimeout } = {}) {
      ...
      stop = watch(r, (v) => {
        if (condition(v) !== isNot) {
          if (stop)
            ...
            nextTick(() => stop === null || stop === void 0 ? void 0 : stop());
          resolve(v);
        }
      }, {
        flush,
    ...
    if (timeout != null)
      promises.push(promiseTimeout(timeout, throwOnTimeout).then(() => toValue(r)).finally(() => stop === null || stop === void 0 ? void 0 : stop()));
...
function useIntervalFn(cb, interval = 1e3, options = {}) {
  ...
  if (isRef(interval) || typeof interval === "function")
    tryOnScopeDispose(watch(interval, () => {
...
function createTemplatePromise(options = {}) {
  ...
  function create(...args) {
    ...
    props.promise = new Promise((_resolve, _reject) => {
      ...
      if (index$1 !== -1)
        instances.value.splice(index$1, 1);
    });
  ...
  const stopWatch = watchEffect(() => {
    ...
    if (el) {
      const { stop } = useMutationObserver(document$1, (mutationsList) => {
        if (mutationsList.map((mutation) => [...mutation.removedNodes]).flat().some((node) => node === el || node.contains(el)))
...
function onLongPress(target, handler, options) {
  ...
  function onRelease(ev) {
    ...
    if (!(options === null || options === void 0 ? void 0 : options.onMouseUp) || !_posStart || !_startTimestamp)
      return;
    if ((options === null || options === void 0 || (_options$modifiers = options.modifiers) === null || _options$modifiers === void 0 ? void 0 : _options$modifiers.self) && ev.target !== elementRef.value)
      return;
    if (options === null || options === void 0 || (_options$modifiers2 = options.modifiers) === null || _options$modifiers2 === void 0 ? void 0 : _options$modifiers2.prevent)
      ev.preventDefault();
    if (options === null || options === void 0 || (_options$modifiers3 = options.modifiers) === null || _options$modifiers3 === void 0 ? void 0 : _options$modifiers3.stop)
      ev.stopPropagation();
  ...
  function onDown(ev) {
    ...
    if ((options === null || options === void 0 || (_options$modifiers4 = options.modifiers) === null || _options$modifiers4 === void 0 ? void 0 : _options$modifiers4.self) && ev.target !== elementRef.value)
      return;
    clear();
    if (options === null || options === void 0 || (_options$modifiers5 = options.modifiers) === null || _options$modifiers5 === void 0 ? void 0 : _options$modifiers5.prevent)
      ev.preventDefault();
    if (options === null || options === void 0 || (_options$modifiers6 = options.modifiers) === null || _options$modifiers6 === void 0 ? void 0 : _options$modifiers6.stop)
      ev.stopPropagation();
    posStart = {
      x: ev.x,
      y: ev.y
  ...
  function onMove(ev) {
    ...
    if ((options === null || options === void 0 || (_options$modifiers7 = options.modifiers) === null || _options$modifiers7 === void 0 ? void 0 : _options$modifiers7.self) && ev.target !== elementRef.value)
      return;
    if (!posStart || (options === null || options === void 0 ? void 0 : options.distanceThreshold) === false)
      return;
    if (options === null || options === void 0 || (_options$modifiers8 = options.modifiers) === null || _options$modifiers8 === void 0 ? void 0 : _options$modifiers8.prevent)
      ev.preventDefault();
    if (options === null || options === void 0 || (_options$modifiers9 = options.modifiers) === null || _options$modifiers9 === void 0 ? void 0 : _options$modifiers9.stop)
      ev.stopPropagation();
    const dx = ev.x - posStart.x;
    const dy = ev.y - posStart.y;
    if (Math.sqrt(dx * dx + dy * dy) >= ((_options$distanceThre = options === null || options === void 0 ? void 0 : options.distanceThreshold) !== null && _options$distanceThre !== void 0 ? _options$distanceThre : DEFAULT_THRESHOLD))
      clear();
  }
...
function onStartTyping(callback, options = {}) {
  ...
  if (document$1)
    useEventListener(document$1, "keydown", keydown, { passive: true });
}
  ...
  const getDeepActiveElement = () => {
    ...
    if (deep) {
      ...
      while (element === null || element === void 0 ? void 0 : element.shadowRoot)
        element = element === null || element === void 0 || (_element$shadowRoot = element.shadowRoot) === null || _element$shadowRoot === void 0 ? void 0 : _element$shadowRoot.activeElement;
    }
    return element;
  };
...
function useAnimate(target, keyframes, options) {
  ...
  useEventListener(animate, "finish", () => {
    var _animate$value5;
    if (commitStyles)
      (_animate$value5 = animate.value) === null || _animate$value5 === void 0 || _animate$value5.commitStyles();
  }, listenerOptions);
  ...
  function syncPause() {
    if (isSupported.value && window$1)
      window$1.requestAnimationFrame(pauseRef);
  }
  return {
    isSupported,
    animate,
    ...
    promise.value = new Promise((resolve, reject) => {
      try {
        ...
        if (_target == null)
          ...
          resolve(_target.toDataURL(options === null || options === void 0 ? void 0 : options.type, options === null || options === void 0 ? void 0 : options.quality));
...
function useBluetooth(options) {
  ...
  tryOnMounted(() => {
    ...
    if (device.value)
      (_device$value$gatt = device.value.gatt) === null || _device$value$gatt === void 0 || _device$value$gatt.connect();
  });
  tryOnScopeDispose(() => {
    var _device$value$gatt2;
    if (device.value)
      (_device$value$gatt2 = device.value.gatt) === null || _device$value$gatt2 === void 0 || _device$value$gatt2.disconnect();
  });
  return {
    isSupported,
...
function useBreakpoints(breakpoints, options = {}) {
  ...
  if (ssrSupport)
    tryOnMounted(() => mounted.value = !!window$1);
...
function useBroadcastChannel(options) {
  ...
  const post = (data$1) => {
    if (channel.value)
      channel.value.postMessage(data$1);
  };
  const close = () => {
    if (channel.value)
      channel.value.close();
...
function useBrowserLocation(options = {}) {
  ...
  for (const [key, ref$1] of objectEntries(refs))
    watch(ref$1, (value) => {
      if (!(window$1 === null || window$1 === void 0 ? void 0 : window$1.location) || window$1.location[key] === value)
        return;
  ...
  const buildState = (trigger) => {
    ...
    for (const key of WRITABLE_PROPERTIES)
      refs[key].value = window$1 === null || window$1 === void 0 || (_window$location = window$1.location) === null || _window$location === void 0 ? void 0 : _window$location[key];
    return reactive({
      trigger,
      state: state$1,
      length,
...
function useStorage(key, defaults$1, storage, options = {}) {
  ...
  if (window$1 && listenToStorageChanges)
    if (storage instanceof Storage)
      ...
      useEventListener(window$1, customStorageEventName, onStorageCustomEvent);
  if (initOnMounted)
    tryOnMounted(() => {
      firstMounted = true;
      update();
...
function useCycleList(list, options) {
  ...
  const index = computed({
    get() {
      ...
      if (index$1 < 0)
        index$1 = (_options$fallbackInde = options === null || options === void 0 ? void 0 : options.fallbackIndex) !== null && _options$fallbackInde !== void 0 ? _options$fallbackInde : 0;
      return index$1;
    },
    set(v) {
      set2(v);
...
function useDark(options = {}) {
  ...
  const mode = useColorMode({
    ...
    onChanged: (mode$1, defaultHandler) => {
      ...
      if (options.onChanged)
        (_options$onChanged = options.onChanged) === null || _options$onChanged === void 0 || _options$onChanged.call(options, mode$1 === "dark", defaultHandler, mode$1);
      else
...
function useDeviceMotion(options = {}) {
  ...
  function init() {
    if (window$1)
      useEventListener(window$1, "devicemotion", createFilterWrapper(eventFilter, (event) => {
...
function useDeviceOrientation(options = {}) {
  ...
  if (window$1 && isSupported.value)
    useEventListener(window$1, "deviceorientation", (event) => {
...
function useDevicePixelRatio(options = {}) {
  ...
  let stop = noop;
  if (window$1)
    stop = watchImmediate(query, () => pixelRatio.value = window$1.devicePixelRatio);
  return {
...
function useDraggable(target, options = {}) {
  ...
  const start = (e) => {
    ...
    if ((onStart === null || onStart === void 0 ? void 0 : onStart(pos, e)) === false)
      return;
...
function useDropZone(target, options = {}) {
  ...
  if (isClient) {
    ...
    const checkDataTypes = (types) => {
      ...
      if (!(dataTypes === null || dataTypes === void 0 ? void 0 : dataTypes.length))
        return true;
      if (types.length === 0)
        return false;
  ...
  const execute = async (throwOnFailed = false) => {
    ...
    if (payload) {
      ...
      if (config.payloadType)
        headers["Content-Type"] = (_payloadMapping$confi = payloadMapping[config.payloadType]) !== null && _payloadMapping$confi !== void 0 ? _payloadMapping$confi : config.payloadType;
    ...
    return (payload, payloadType) => {
      if (!isFetching.value) {
        ...
        if (isRef(config.payload))
          watch([refetch, toRef2(config.payload)], ([refetch$1]) => refetch$1 && execute(), { deep: true });
        return {
          ...shell,
          then(onFulfilled, onRejected) {
...
function useFileDialog(options = {}) {
  ...
  const applyOptions = (options$1) => {
    ...
    if (hasOwn(options$1, "capture"))
      el.capture = toValue(options$1.capture);
  };
...
function useFileSystemAccess(options = {}) {
  ...
  async function updateData() {
    ...
    if (type === "Text")
      data.value = await ((_file$value5 = file.value) === null || _file$value5 === void 0 ? void 0 : _file$value5.text());
    else if (type === "ArrayBuffer")
      data.value = await ((_file$value6 = file.value) === null || _file$value6 === void 0 ? void 0 : _file$value6.arrayBuffer());
    else if (type === "Blob")
...
function useFocus(target, options = {}) {
  ...
  useEventListener(targetElement, "focus", (event) => {
    var _matches, _ref;
    if (!focusVisible || ((_matches = (_ref = event.target).matches) === null || _matches === void 0 ? void 0 : _matches.call(_ref, ":focus-visible")))
  ...
  const focused = computed({
    ...
    set(value) {
      ...
      if (!value && innerFocused.value)
        (_targetElement$value = targetElement.value) === null || _targetElement$value === void 0 || _targetElement$value.blur();
      else if (value && !innerFocused.value)
        (_targetElement$value2 = targetElement.value) === null || _targetElement$value2 === void 0 || _targetElement$value2.focus({ preventScroll });
    }
  });
  watch(targetElement, () => {
...
function useFocusWithin(target, options = {}) {
  ...
  if (!window$1 || !activeElement.value)
    return { focused };
  const listenerOptions = { passive: true };
...
function useFullscreen(target, options = {}) {
  ...
  const isCurrentElementFullScreen = () => {
    if (fullscreenElementMethod)
      return (document$1 === null || document$1 === void 0 ? void 0 : document$1[fullscreenElementMethod]) === targetRef.value;
    return false;
  };
...
function useGeolocation(options = {}) {
  ...
  if (immediate)
    resume();
  function pause() {
    if (watcher && navigator$1)
      navigator$1.geolocation.clearWatch(watcher);
  }
  tryOnScopeDispose(() => {
    pause();
  });
...
function useIdle(timeout = oneMinute, options = {}) {
  ...
  if (window$1) {
    ...
    for (const event of events$1)
      useEventListener(window$1, event, () => {
        if (!isPending.value)
          return;
        onEvent();
      }, listenerOptions);
    if (listenForVisibilityChange)
      useEventListener(document$1, "visibilitychange", () => {
        if (document$1.hidden || !isPending.value)
          return;
        onEvent();
      }, listenerOptions);
    start();
...
function useScroll(element, options = {}) {
  ...
  if ((observe === null || observe === void 0 ? void 0 : observe.mutation) && element != null && element !== window$1 && element !== document)
...
function useMagicKeys(options = {}) {
  ...
  const proxy = new Proxy(refs, { get(target$1, prop, rec) {
    if (typeof prop !== "string")
      return Reflect.get(target$1, prop, rec);
      ...
      usingElRef(target, async (el) => {
        if (supportsPictureInPicture)
          if (!isPictureInPicture.value)
            ...
            document$1.exitPictureInPicture().then(resolve).catch(reject);
      });
    });
  };
  watchEffect(() => {
...
function useNavigatorLanguage(options = {}) {
  ...
  useEventListener(window$1, "languagechange", () => {
    if (navigator$1)
      language.value = navigator$1.language;
  }, { passive: true });
  return {
    isSupported,
    language
...
function useScreenOrientation(options = {}) {
  ...
  if (isSupported.value)
    useEventListener(window$1, "orientationchange", () => {
  ...
  return {
    roll: computed(() => {
      if (source.value === "deviceOrientation") {
        ...
        return mouseRollAdjust(-(y.value - height.value / 2) / height.value);
    }),
    tilt: computed(() => {
      if (source.value === "deviceOrientation") {
        let value;
        ...
        return mouseTiltAdjust((x.value - width.value / 2) / width.value);
    }),
    source
  };
}
...
function usePointerSwipe(target, options = {}) {
  ...
  const stops = [
    ...
    useEventListener(target, "pointermove", (e) => {
      ...
      if (isSwiping.value)
        onSwipe === null || onSwipe === void 0 || onSwipe(e);
    }, listenerOptions),
...
function useScriptTag(src, onLoaded = noop, options = {}) {
  ...
  const loadScript = (waitForScriptLoad) => new Promise((resolve, reject) => {
    ...
    if (shouldAppend)
      el = document$1.head.appendChild(el);
  ...
  const unload = () => {
    ...
    if (el)
      document$1.head.removeChild(el);
  };
  if (immediate && !manual)
    tryOnMounted(load);
  if (!manual)
  ...
  return computed({
    ...
    set(v) {
      ...
      if (!document$1)
        return;
      if (dir.value)
        (_document$querySelect2 = document$1.querySelector(selector)) === null || _document$querySelect2 === void 0 || _document$querySelect2.setAttribute("dir", dir.value);
      else
        (_document$querySelect3 = document$1.querySelector(selector)) === null || _document$querySelect3 === void 0 || _document$querySelect3.removeAttribute("dir");
    }
  });
}
...
function useTextSelection(options = {}) {
  ...
  function onSelectionChange() {
    ...
    if (window$1)
      selection.value = window$1.getSelection();
  }
  if (window$1)
...
function useTitle(newTitle = null, options = {}) {
  ...
  tryOnScopeDispose(() => {
    if (restoreOnUnmount) {
      ...
      if (restoredTitle != null && document$1)
        document$1.title = restoredTitle;
    }
  });
  return title;
}
...
function useUrlSearchParams(mode = "history", options = {}) {
  ...
  function getRawParams() {
    if (mode === "history")
      return window$1.location.search || "";
    else if (mode === "hash") {
      const hash = window$1.location.hash || "";
      const index = hash.indexOf("?");
      return index > 0 ? hash.slice(index) : "";
    } else
      return (window$1.location.hash || "").replace(/^#/, "");
  }
  ...
  function write(params, shouldUpdate, shouldWriteHistory = true) {
    ...
    if (writeMode === "replace")
      ...
      window$1.history.pushState(window$1.history.state, window$1.document.title, window$1.location.pathname + constructQuery(params));
    nextTick(() => resume());
  }
  function onChanged() {
    if (!enableWrite)
...
function useVibrate(options) {
  ...
  const vibrate = (pattern$1 = patternRef.value) => {
    if (isSupported.value)
      navigator$1.vibrate(pattern$1);
  };
  const stop = () => {
    if (isSupported.value)
      navigator$1.vibrate(0);
...
function useWebNotification(options = {}) {
  ...
  const isSupported = useSupported(() => {
    if (!window$1 || !("Notification" in window$1))
      return false;
...
function useWindowSize(options = {}) {
  ...
  if (listenOrientation)
    watch(useMediaQuery("(orientation: portrait)"), () => update());
  return {
    width,
    height
  };
